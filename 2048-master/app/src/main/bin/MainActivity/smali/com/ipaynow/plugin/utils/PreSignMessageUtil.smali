...
.method public generatePreSignMessage()Ljava/lang/String;
    ...
    invoke-virtual {v0, v10}, Lcom/ipaynow/plugin/manager/cache/MessageCache;->setUsePreSignToolsFlag(Z)V
    ...
    invoke-static {v4}, Lcom/ipaynow/plugin/utils/PreSignMessageUtil;->createLinkString(Ljava/util/HashMap;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-virtual {v1, v10}, Lcom/ipaynow/plugin/manager/cache/MessageCache;->setAddMustRequestParamsFlag(Z)Lcom/ipaynow/plugin/manager/cache/MessageCache;
