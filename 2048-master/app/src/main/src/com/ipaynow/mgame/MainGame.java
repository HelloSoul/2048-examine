...
public class MainGame {
    ...
    public void newGame() {
        ...
        gameCount = preferences.getLong("gameCount", 0);
        edit.putLong("gameCount", gameCount+1);
        edit.commit();
        Log.i("TAG", "gameCount = "+preferences.getLong("gameCount", 0));
        if(gameCount>=preferences.getLong("totalCount", 3)){
            //TODO 
            mView.ads.loadIPayNowAds(mContext);
        }
